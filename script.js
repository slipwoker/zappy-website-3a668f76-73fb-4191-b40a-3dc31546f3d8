    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '3a668f76-73fb-4191-b40a-3dc31546f3d8',
                    name: data.name || '',
                    email: data.email || '',
...
/* Integration Scripts */
// setup_contact_form_emails functionality
// Email integration configured for Shailiro by Tania Avigail
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '3a668f76-73fb-4191-b40a-3dc31546f3d8';
    ...
    function showFallbackContact() {
            ...
            if (mobileToggle && navMenu) {
                ...
                if (phoneHeaderBtn) {
                    phoneHeaderBtn.addEventListener('click', function() {
                        ...
                        // Falls back to 054-7803787 placeholder which businessInfoUpdater can replace
        ...
        (function disablePlaceholderLinks() {
            ...
            const socialPlaceholders = [
                ...
                'https://facebook.com/shailirojewelry',
                'https://instagram.com/shailiro_jewelry',
                'https://instagram.com/shailiro_jewelry',
                'https://wa.me/972547803787',
                'https://wa.me/972547803787',
                '[social_twitter]',
                '[social_linkedin]',
                '[social_youtube]',
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '3a668f76-73fb-4191-b40a-3dc31546f3d8';
